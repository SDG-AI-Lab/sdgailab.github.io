...
export const PROFILES = [
  {
    ...
    bio: (
      <>
        ...
        <p>
          “I come from the Northwest region of Cameroon which has been affected
          by a bloody and deadly civil war since 2016. Thousands have lost their
          lives. Many have fled their homes to neighbouring cities and
          countries. I have lost a few friends and have seen schools and
          hospitals burned to the ground. I understand first-hand what it means
          to live in seemingly never-ending fear and suffering. This experience,
  ...
  },
  {
    ...
    bio: (
      <>
        ...
        <p>
          In the pursuit of a better and more sustainable world, data scientists
          have their unique roles and responsibilities. As a word of
          encouragement and caution for fellow data scientists and future
          ...
          subjects and they should seek ways to improve their communication and
          collaboration skills as well. In this regard, they should not be
          ...
          responsible and open-minded towards these topics and do their best for
    ...
    bio: (
      <>
        <p>
          ...
          the monitoring and tracking of existing and emerging digital solutions
          for anticipatory risk, risk reduction and crisis recovery.{' '}
        </p>
        <p>
          “I really want to see more women in the field of data science. I
          believe that women should listen to their inner voice and go for what
          they want without any hesitation.”
        </p>
        <p>
    ...
    bio: (
      <>
        <p>
          ...
          data science volunteers from 45 countries to develop digital solutions
        ...
        <p>
          ...
          online, in order for areas facing disasters to know how to respond and
          prevent damages.”
        </p>
      </>
    ),
    ...
    bio: (
      <>
        ...
        <p>
          ...
          vulnerability assessment, and I feel an attachment to the improvement
          efforts on this approach. Another project aims to reach out to
          children in earthquake-affected region and support them in an
          appropriate way.”
        </p>
      </>
    ),
