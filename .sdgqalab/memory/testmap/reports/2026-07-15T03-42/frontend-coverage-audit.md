...
audited_at: "2026-07-15T03:42:00+02:00"
config_version: 3
...
delta:
  previous_audit: "2026-07-15T03:25"
  unit_file_coverage_change: 7.3
  integration_file_coverage_change: 0.0
  line_coverage_change: 9.41
  e2e_gaps_change: 0
...
> **Unit File Coverage**: 27.9% (19/68 files) - Critical
> **Integration File Coverage**: 0.0% (0/68 files) - Critical
> **Line Coverage**: 39.68% - Critical
> **Tests**: 68
> **Audited**: 2026-07-15
...
- Nineteen automated test files now cover library logic, admin auth, admin login behavior, admin media upload behavior, admin project/news/statistics form behavior, shared slug/status/content-form helpers, toast behavior, statistics list behavior, and project-card rendering.
...
- Coverage continues trending upward on the broader frontend baseline.
...
|------|-------|--------------|
| `src/islands/admin/page-content/PageContentFormPage.tsx` | islands | Create/update interaction, validation feedback, and navigation on success |
| `src/islands/admin/partners/PartnerFormPage.tsx` | islands | Create/update interaction, validation feedback, and image/link handling |
| `src/islands/admin/people/PersonFormPage.tsx` | islands | Create/update interaction, validation feedback, and group selection behavior |
...
1. **[P1]** Add focused UI tests for adjacent admin surfaces such as `src/islands/admin/page-content/PageContentFormPage.tsx`, `src/islands/admin/partners/PartnerFormPage.tsx`, and `src/islands/admin/people/PersonFormPage.tsx` to keep lifting the broader island baseline.
