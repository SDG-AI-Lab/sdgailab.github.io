...
audited_at: "2026-07-15T03:10:00+02:00"
config_version: 3
...
delta:
  previous_audit: "2026-07-15T03:00"
  unit_file_coverage_change: 1.4
  integration_file_coverage_change: 0.0
  line_coverage_change: 4.08
  e2e_gaps_change: 0
...
> **Unit File Coverage**: 17.6% (12/68 files) - Critical
> **Integration File Coverage**: 0.0% (0/68 files) - Critical
> **Line Coverage**: 28.14% - Critical
> **Tests**: 51
> **Audited**: 2026-07-15
...
- Twelve automated test files now cover library logic, admin auth, admin login behavior, admin media upload behavior, admin project-form behavior, admin news-form behavior, and admin page security behavior.
...
- Coverage is trending upward again on the broader, more honest baseline.
...
1. **[P1]** Add focused UI tests for adjacent admin surfaces such as `src/islands/admin/statistics/StatisticFormPage.tsx`, `src/islands/admin/shared/SlugField.tsx`, and `src/islands/admin/shared/StatusSelect.tsx` to keep lifting the broader island baseline.
