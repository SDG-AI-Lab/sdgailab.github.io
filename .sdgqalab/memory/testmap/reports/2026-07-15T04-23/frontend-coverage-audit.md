...
audited_at: "2026-07-15T04:23:00+02:00"
config_version: 3
...
delta:
  previous_audit: "2026-07-15T03:42"
  unit_file_coverage_change: 4.5
  integration_file_coverage_change: 0.0
  line_coverage_change: 10.98
  e2e_gaps_change: 0
...
> **Unit File Coverage**: 32.4% (22/68 files) - Low
> **Integration File Coverage**: 0.0% (0/68 files) - Critical
> **Line Coverage**: 50.66% - Low
> **Tests**: 77
> **Audited**: 2026-07-15
...
- Twenty-two automated test files now cover library logic, admin auth, admin login behavior, admin media upload behavior, admin project/news/statistics/page-content/partner/people form behavior, shared slug/status/content-form helpers, toast behavior, statistics list behavior, and project-card rendering.
...
- Coverage has moved from Critical toward a more workable baseline, especially across `src/islands/admin/**`.
...
| `src/islands/admin/page-content/PageContentListPage.tsx` | islands | List fetch, edit routing, archive/delete actions, and retry behavior |
| `src/islands/admin/partners/PartnersListPage.tsx` | islands | List fetch, edit routing, archive/delete actions, and retry behavior |
| `src/islands/admin/people/PeopleListPage.tsx` | islands | List fetch, filters, edit routing, archive/delete actions, and retry behavior |
| `src/islands/admin/news/NewsListPage.tsx` | islands | List fetch, edit routing, archive/delete actions, and retry behavior |
| `src/islands/admin/projects/ProjectsListPage.tsx` | islands | List fetch, edit routing, archive/delete actions, and retry behavior |
| `src/islands/admin/shared/ConfirmDialog.tsx` | islands | Open/close state, confirm/cancel callbacks, and loading state |
| `src/islands/admin/shared/ContentTable.tsx` | islands | Error/loading/empty states and action-button wiring |
...
The current unit tests are focused and deterministic. The biggest remaining gap is now uncovered list/detail/admin-layout surfaces plus missing integration, E2E, and accessibility coverage.

---

## Recommendations

1. **[P1]** Add focused UI tests for the remaining admin list surfaces and shared table/dialog primitives to keep raising the island baseline with reusable patterns.
