...
audited_at: "2026-07-15T04:49:00+02:00"
config_version: 3
...
> **Unit File Coverage**: 47.1% (32/68 files) - Low
> **Integration File Coverage**: 0.0% (0/68 files) - Critical
> **Line Coverage**: 71.52% - Adequate
> **Tests**: 107
> **Audited**: 2026-07-15
...
- Thirty-two automated test files now cover library logic, admin auth, admin login behavior, admin media upload behavior, admin project/news/statistics/page-content/partner/people form behavior, admin list surfaces, admin shell/dashboard behavior, shared dialog/table/markdown/slug/status/content-form helpers, toast behavior, and project-card rendering.
...
- Coverage is now materially stronger across `src/islands/admin/**`, with dashboard, layout, and Markdown editor surfaces joining the previously hardened CRUD forms and list pages.
...
| islands | `src/islands/admin/layout/AdminLayout.test.tsx` | 3 | `src/islands/admin/layout/AdminLayout.tsx` |
| islands | `src/islands/admin/dashboard/DashboardPage.test.tsx` | 3 | `src/islands/admin/dashboard/DashboardPage.tsx` |
...
| `src/islands/NewsDetail.tsx` | islands | Detail fetch lifecycle, not-found handling, and rendered article content |
| `src/islands/ProjectDetail.tsx` | islands | Detail fetch lifecycle, not-found handling, and rendered project content |
...
The current unit tests are focused and deterministic. The biggest remaining gap is now concentrated in public-content islands plus a few small admin-shell helpers, while integration, E2E, and accessibility coverage are still completely absent.

---

## Recommendations

1. **[P1]** Add focused UI tests for `AdminApp`, `Sidebar`, `AuthCallback`, and the remaining public-content islands to keep converting zero-coverage surfaces into maintained baselines.
